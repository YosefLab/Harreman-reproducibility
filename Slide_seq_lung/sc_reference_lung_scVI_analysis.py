...
adata = sc.read_h5ad(os.path.join(ADATA_PATH, 'Slide_seq_lung_sc_ref_revision_adata.h5ad'))
...
MODEL_PATH = os.path.join(MODELS_PATH, 'Slide_seq_lung_sc_ref_revision_scVI')
DATA_PATH = os.path.join(ADATA_PATH, 'Slide_seq_lung_sc_ref_revision_scVI_adata.h5ad')
