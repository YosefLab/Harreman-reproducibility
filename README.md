...
- *Slide_seq_lung*: This folder contains the scripts and notebooks needed to process the Slide-seq human lung dataset as well as to reproduce Figures 2, 3, S3, S4, S5, and S6.
- *Visim_colon*: This folder contains the scripts and notebooks needed to process the 10x Visium mouse colon dataset as well as to reproduce Figures 4, 5, S7, S8, S9, and S10.
